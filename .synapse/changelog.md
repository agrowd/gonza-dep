...
- Corrección del desglose en la tarjeta de resumen financiero: el **Total Base (Zonas)** muestra directamente el precio base real (ej. $140.000) sin sumar erróneamente la bonificación ($70.000), garantizando que el **Descuento Aplicado (-$70.000)** reste del total base para dar el **Monto Final de Venta ($70.000)** y el **Saldo a Pagar en Local ($35.000)**.
