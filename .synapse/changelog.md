...
- Solución definitiva al error `Error al verificar el Email. Por favor intenta nuevamente` eliminando el argumento no soportado `mode: 'insensitive'` de las consultas de Prisma en la API pública de reservas (`/api/clientes/consultar`).
