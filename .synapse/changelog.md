...
- Inclusión explícita de `descuentoTipo` y `descuentoValor` en la petición `PUT` de modificación/reprogramación de turnos (`handleSaveEditTurno` en `src/app/admin/agenda/page.js`), garantizando que cualquier cambio en el porcentaje o tipo de descuento se guarde de forma permanente en PostgreSQL.
