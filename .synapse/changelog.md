...
- Incorporación de la fila **Descuento Aplicado** debajo del Saldo Pendiente tanto en la ficha del turno de la agenda (`src/app/admin/agenda/page.js`) como en el panel público de **Autogestión** (`src/app/page.js`), mostrando el monto bonificado en rojo con su porcentaje o valor fijo especificado (ej. `-$6.000 (20%)`).
