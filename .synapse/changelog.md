...
- Reemplazo del logo en el panel administrativo por el recurso oficial `/Logo-Gonzalo-Depilacion-para-hombres-Blanco.png` (`src/app/admin/SidebarNav.js`): se removieron los filtros CSS y se vinculó directamente la imagen transparente blanca oficial en la barra lateral del admin.
