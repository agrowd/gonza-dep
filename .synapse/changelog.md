...
- Preservación del precio total base antes de descuento al abrir el modal de edición (`handleOpenEditModal`): se inicializa `manualTotalOverride` con la suma del precio cobrado más la bonificación ($24.000 + $6.000 = $30.000), impidiendo que al reprogramar o editar un turno señado se aplique nuevamente el 20% sobre la venta ya descontada.
