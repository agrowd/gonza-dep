...
const BotIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2"></rect><circle cx="12" cy="5" r="2"></circle><path d="M12 7v4"></path><line x1="8" y1="16" x2="8.01" y2="16"></line><line x1="16" y1="16" x2="16.01" y2="16"></line></svg>
);
...
export default function SidebarNav({ user }) {
  ...
  const navItems = [
    ...
    { name: 'Bandeja IA', path: 'https://admin.depilacionparahombres.com/chats', icon: <BotIcon />, external: true },
